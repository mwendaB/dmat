...
function Testimonials() {
  ...
  return (
    <div className="flex flex-col rounded-none">
      ...
      <div className="self-center mt-4 text-base leading-8 text-center text-neutral-900 w-[555px] max-md:max-w-full">
  ...
  {testimonials.map((testimonial, index) => (
    <div
      key={index}
      className="flex flex-col px-8 py-7 mx-4 bg-white rounded-xl border-2 border-red-700" // Add mx-4 for horizontal spacing
    >
